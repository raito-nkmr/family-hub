...
import { CheckIcon, LogoutIcon, MoonIcon, SunIcon } from '../../shared/ui/icons'
...
export function RequiredPasswordChangeScreen({
  ...
  return (
    <main className="login-page">
      ...
      <section className="login-panel" aria-labelledby="required-password-change-heading">
        <span className="brand__mark login-panel__mark">
          <CheckIcon />
        </span>
        <p className="eyebrow">{t('auth.eyebrow')}</p>
        <h1 id="required-password-change-heading">{t('auth.mustChangeTitle')}</h1>
        <p className="login-panel__description">{t('auth.mustChangeDescription', { username })}</p>
