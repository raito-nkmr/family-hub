...
import { ChoreCategoryManagerDialog } from './ChoreCategoryManagerDialog'
...
const secondCategory: ChoreCategory = {
  ...category,
...
function renderDialog(overrides: Partial<ComponentProps<typeof ChoreCategoryManagerDialog>> = {}) {
  return render(
...
describe('ChoreCategoryManagerDialog', () => {
